...
class BibleComScraper:
    def __init__(self, version_id="CUNPSS-神"):
        """
        初始化爬蟲
    ...
    def fetch_chapter(self, book_abbr, chapter):
        ...
        :return: 經文列表
        """
        url = f"{self.base_url}/40/{book_abbr}.{chapter}.{self.version_id}"
        print(f"正在抓取：{url}")
...
if __name__ == "__main__":
    ...
    scraper = BibleComScraper(version_id="CNV")
    scraper.scrape_all("bible_cnv.json")
